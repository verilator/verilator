...
automatically add coverage analysis at each expression which can be
reduced to a boolean truth table.

Multi-bit expressions are ignored, but sub-expressions with are completely
