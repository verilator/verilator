...
void VerilatedVcd::dumpHeader() {
    ...
    // There used to be a stanza here to emit a $date line.
    // Suggest just using the file timestamp, instead.
    // This approach removes redundant functionality and means
    // artifacts are more likely to be reproducible.
