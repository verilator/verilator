...
extern IData VL_RAND_RESET_I_A(int obits) VL_MT_SAFE;
/// Random reset a signal of given width (assign time only)
extern QData VL_RAND_RESET_Q_A(int obits) VL_MT_SAFE;
/// Random reset a signal of given width (assign time only)
extern WDataOutP VL_RAND_RESET_W_A(int obits, WDataOutP outwp) VL_MT_SAFE;
