...
extern WDataOutP VL_ZVALUE_RESET_W(int obits, WDataOutP outwp) VL_MT_SAFE;
...
// clang-format off
#define VL_SET_WQ_GEN(outputSuffix) \
inline WDataOutP VL_SET_WQ_##outputSuffix(WDataOutP owp, QData data) VL_PURE { \
        *VL_GET_ELEM(outputSuffix, owp, 0) = static_cast<EData>(data); \
        *VL_GET_ELEM(outputSuffix, owp, 1) = static_cast<EData>((data) >> VL_EDATASIZE); \
        return owp; \
    }
// clang-format on
VL_GEN_HELPER_ONE_ARG(VL_SET_WQ_GEN)
#undef VL_SET_WQ_GEN

// clang-format off
#define VL_SET_WI_GEN(outputSuffix) \
inline WDataOutP VL_SET_WI_##outputSuffix(WDataOutP owp, IData data) VL_PURE { \
        *VL_GET_ELEM(outputSuffix, owp, 0) = static_cast<EData>(data); \
        *VL_GET_ELEM(outputSuffix, owp, 1) = 0; \
        return owp; \
    }
// clang-format on
VL_GEN_HELPER_ONE_ARG(VL_SET_WI_GEN)
#undef VL_SET_WI_GEN

// clang-format off
#define VL_SET_QW_GEN(lhsSuffix) \
inline QData VL_SET_QW_##lhsSuffix(WDataInP lwp) VL_PURE { \
        return static_cast<QData>(*VL_GET_ELEM(lhsSuffix, lwp, 0)) \
               | (static_cast<QData>(*VL_GET_ELEM(lhsSuffix, lwp, 1)) \
                  << static_cast<QData>(VL_EDATASIZE)); \
    }
// clang-format on
VL_GEN_HELPER_ONE_ARG(VL_SET_QW_GEN)
#undef VL_SET_QW_GEN

inline QData VL_SET_QII(IData ld, IData rd) VL_PURE {
    return (static_cast<QData>(ld) << 32ULL) | static_cast<QData>(rd);
}
...
inline void* VL_CVT_Q_VP(QData lhs) VL_PURE {
    union { void* fp; QData q; } u;
    u.q = lhs;
    return u.fp;
}
// Return QData from const void*
inline QData VL_CVT_VP_Q(const void* fp) VL_PURE {
...
inline double VL_CVT_D_Q(QData lhs) VL_PURE {
    union { double d; QData q; } u;
    u.q = lhs;
    return u.d;
}
// Return QData from double (bits, not numerically)
inline QData VL_CVT_Q_D(double lhs) VL_PURE {
    union { double d; QData q; } u;
    u.d = lhs;
    return u.q;
}
...
inline std::string VL_CVT_N_CSTR(const char* lhsp) VL_PURE {
    return lhsp ? std::string{lhsp} : ""s;
}

// Return queue from an unpacked array
template <typename T, std::size_t N_Depth>
inline VlQueue<T> VL_CVT_UNPACK_TO_Q(const VlUnpacked<T, N_Depth>& q) VL_PURE {
    VlQueue<T> ret;
...
inline IData VL_MATCHMASKED_Q(int, QData lhs, WDataInP matchp) VL_PURE {
    size_t i = 0;
    while (true) {
        const QData mask = VL_SET_QW_T(matchp + i * 4);
        const QData bits = VL_SET_QW_T(matchp + i * 4 + 2);
        if ((mask & lhs) == bits) break;
        ++i;
    }
    return i;
}
inline IData VL_MATCHMASKED_W(int lbits, WDataInP lhsp, WDataInP matchp) VL_MT_SAFE {
...
inline double VL_ITOR_D_I(int, IData lhs) VL_PURE {
    return static_cast<double>(static_cast<uint32_t>(lhs));
}
inline double VL_ITOR_D_Q(int, QData lhs) VL_PURE {
...
inline double VL_ISTOR_D_I(int lbits, IData lhs) VL_MT_SAFE {
    if (lbits == 32) return static_cast<double>(static_cast<int32_t>(lhs));
    VlWide<VL_WQ_WORDS_E> lwp;
    VL_SET_WI_T(lwp, lhs);
    return VL_ISTOR_D_W(lbits, lwp);
}
inline double VL_ISTOR_D_Q(int lbits, QData lhs) VL_MT_SAFE {
...
inline IData VL_RTOI_I_D(double lhs) VL_PURE { return static_cast<int32_t>(VL_TRUNC(lhs)); }
...
inline IData VL_EXTENDSIGN_I(int lbits, IData lhs) VL_PURE {
    return (-((lhs) & (VL_UL(1) << (lbits - 1))));
}
inline QData VL_EXTENDSIGN_Q(int lbits, QData lhs) VL_PURE {
...
inline WDataOutP _vl_clean_inplace_w_##outputSuffix(int obits, WDataOutP owp) \
        VL_MT_SAFE { \
...
inline WDataOutP VL_ZERO_W_T(int obits, WDataOutP owp) VL_MT_SAFE {
    return VL_MEMSET_ZERO_W(owp, VL_WORDS_I(obits));
}

// clang-format off
#define VL_ZERO_W_GEN(outputSuffix) \
inline WDataOutP VL_ZERO_W_##outputSuffix(int obits, WDataOutP owp) VL_MT_SAFE { \
...
inline WDataOutP VL_ALLONES_W_T(int obits, WDataOutP owp) VL_MT_SAFE {
    const int words = VL_WORDS_I(obits);
...
inline WDataOutP VL_ALLONES_W_##outputSuffix(int obits, WDataOutP owp) VL_MT_SAFE { \
        const WDataOutP resultp = owp; \
        owp += VL_GET_TYPE_OFFSET(outputSuffix); \
...
inline WDataOutP VL_ZVALUE_W(int obits, WDataOutP owp) VL_MT_SAFE {
    const WDataOutP resultp = owp;
    for (int i = 1; i < VL_WORDS_I(obits); ++i) {
        VL_MEMSET_ZERO_W(owp, 1);
        owp += 1;
...
inline WDataOutP VL_ASSIGN_W_TT(int obits, WDataOutP owp, WDataInP const lwp) VL_MT_SAFE {
    return VL_MEMCPY_W(owp, lwp, VL_WORDS_I(obits));
}

// clang-format off
#define VL_ASSIGN_W_GEN(outputSuffix, inputSuffix) \
inline  WDataOutP VL_ASSIGN_W_##outputSuffix##inputSuffix(int obits, WDataOutP owp, WDataInP lwp) \
        VL_MT_SAFE { \
...
inline void VL_ASSIGNBIT_II(int bit, CData& lhsr, IData rhs) VL_PURE {
    lhsr = ((lhsr & ~(VL_UL(1) << VL_BITBIT_I(bit))) | (rhs << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_II(int bit, SData& lhsr, IData rhs) VL_PURE {
    lhsr = ((lhsr & ~(VL_UL(1) << VL_BITBIT_I(bit))) | (rhs << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_II(int bit, IData& lhsr, IData rhs) VL_PURE {
    lhsr = ((lhsr & ~(VL_UL(1) << VL_BITBIT_I(bit))) | (rhs << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_QI(int bit, QData& lhsr, QData rhs) VL_PURE {
    lhsr = ((lhsr & ~(1ULL << VL_BITBIT_Q(bit))) | (static_cast<QData>(rhs) << VL_BITBIT_Q(bit)));
}
inline void VL_ASSIGNBIT_WI(int bit, WDataOutP owp, IData rhs) VL_MT_SAFE {
...
inline void VL_ASSIGNBIT_IO(int bit, CData& lhsr) VL_PURE {
    lhsr = (lhsr | (VL_UL(1) << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_IO(int bit, SData& lhsr) VL_PURE {
    lhsr = (lhsr | (VL_UL(1) << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_IO(int bit, IData& lhsr) VL_PURE {
    lhsr = (lhsr | (VL_UL(1) << VL_BITBIT_I(bit)));
}
inline void VL_ASSIGNBIT_QO(int bit, QData& lhsr) VL_PURE {
    lhsr = (lhsr | (1ULL << VL_BITBIT_Q(bit)));
}
inline void VL_ASSIGNBIT_WO(int bit, WDataOutP owp) VL_MT_SAFE {
    const EData orig = owp[VL_BITWORD_E(bit)];
    owp[VL_BITWORD_E(bit)] = (orig | (VL_EUL(1) << VL_BITBIT_E(bit)));
}
...
inline WDataOutP VL_EXTEND_WI_##outputSuffix##T(int obits, int, WDataOutP owp, IData ld) \
        VL_MT_SAFE { \
...
inline WDataOutP VL_EXTEND_WQ_##outputSuffix##T(int obits, int, WDataOutP const owp, \
                                                           QData ld) VL_MT_SAFE { \
...
inline WDataOutP VL_EXTEND_WW_##outputSuffix##lhsSuffix( \
...
inline IData VL_EXTENDS_II_TT(int, int lbits, IData lhs) VL_PURE {
    return VL_EXTENDSIGN_I(lbits, lhs) | lhs;
}
inline QData VL_EXTENDS_QI_TT(int, int lbits, QData lhs /*Q_as_need_extended*/) VL_PURE {
    return VL_EXTENDSIGN_Q(lbits, lhs) | lhs;
}
inline QData VL_EXTENDS_QQ_TT(int, int lbits, QData lhs) VL_PURE {
    return VL_EXTENDSIGN_Q(lbits, lhs) | lhs;
}

// clang-format off
#define VL_EXTENDS_WI_GEN(outputSuffix) \
inline WDataOutP VL_EXTENDS_WI_##outputSuffix##T(int obits, int lbits, WDataOutP owp, \
                                                            IData ld) VL_MT_SAFE { \
        const WDataOutP resultp = owp; \
        owp += VL_GET_TYPE_OFFSET(outputSuffix); \
        *owp = ld; \
...
inline WDataOutP VL_EXTENDS_WQ_##outputSuffix##T(int obits, int lbits, WDataOutP owp, \
                                                            QData ld) VL_MT_SAFE { \
        VL_SET_WQ_##outputSuffix(owp, ld); \
...
inline WDataOutP VL_EXTENDS_WW_##outputSuffix##lhsSuffix( \
...
inline IData VL_REDAND_W_##lhsSuffix(int lbits, WDataInP lwp) VL_PURE { \
...
inline IData VL_REDOR_W_##lhsSuffix(int words, WDataInP lwp) VL_PURE { \
        EData equal = 0; \
        lwp = lwp + VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline IData VL_REDXOR_2(IData r) VL_PURE {
    // Experiments show VL_REDXOR_2 is faster than __builtin_parityl
    r = (r ^ (r >> 1));
    return r;
}
inline IData VL_REDXOR_4(IData r) VL_PURE {
...
inline IData VL_REDXOR_8(IData r) VL_PURE {
#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    return __builtin_parityl(r);
#else
    r = (r ^ (r >> 1));
...
inline IData VL_REDXOR_16(IData r) VL_PURE {
#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    return __builtin_parityl(r);
#else
    r = (r ^ (r >> 1));
...
inline IData VL_REDXOR_32(IData r) VL_PURE {
#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
    return __builtin_parityl(r);
#else
    r = (r ^ (r >> 1));
...
inline IData VL_REDXOR_64(QData r) VL_PURE {
#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
...
inline IData VL_REDXOR_W_##lhsSuffix(int words, WDataInP lwp) VL_PURE { \
        lwp = lwp + VL_GET_TYPE_OFFSET(lhsSuffix); \
        EData r = *lwp; \
...
inline IData VL_COUNTBITS_I(int lbits, IData lhs, IData ctrl0, IData ctrl1, IData ctrl2) VL_PURE {
...
inline IData VL_COUNTBITS_Q(int lbits, QData lhs, IData ctrl0, IData ctrl1, IData ctrl2) VL_PURE {
...
inline IData VL_COUNTBITS_W(int lbits, int words, WDataInP const lwp, IData ctrl0, IData ctrl1,
...
inline IData VL_ONEHOT_I(IData lhs) VL_PURE {
    const IData y = lhs - 1;
    return y < (lhs ^ y);
}
inline IData VL_ONEHOT_Q(QData lhs) VL_PURE {
    const QData y = lhs - 1;
    return y < (lhs ^ y);
}
inline IData VL_ONEHOT_W(int words, WDataInP const lwp) VL_PURE {
    EData one = 0;
    for (int i = 0; (i < words); ++i) {
        if (lwp[i]) {
            if (one) return 0;
...
inline IData VL_ONEHOT0_I(IData lhs) VL_PURE { return ((lhs & (lhs - 1)) == 0); }
inline IData VL_ONEHOT0_Q(QData lhs) VL_PURE { return ((lhs & (lhs - 1)) == 0); }
inline IData VL_ONEHOT0_W(int words, WDataInP const lwp) VL_PURE {
    bool one = false;
    for (int i = 0; (i < words); ++i) {
        if (lwp[i]) {
            if (one) return 0;
...
inline IData VL_CLOG2_I(IData lhs) VL_PURE {
...
inline IData VL_CLOG2_Q(QData lhs) VL_PURE {
    if (VL_UNLIKELY(!lhs)) return 0;
    --lhs;
    int shifts = 0;
...
inline IData VL_CLOG2_W(int words, WDataInP const lwp) VL_PURE {
...
inline IData VL_MOSTSETBITP1_I_T(IData lhs) VL_PURE {
...
inline IData VL_MOSTSETBITP1_Q_T(QData lhs) VL_PURE {
    if (VL_UNLIKELY(!lhs)) return 0;
#if defined(__GNUC__) && (__GNUC__ >= 4) && !defined(VL_NO_BUILTINS)
...
inline IData VL_MOSTSETBITP1_W_##suffix(int words, WDataInP lwp) VL_PURE { \
...
inline WDataOutP VL_##name##_W_##outputSuffix##lhsSuffix##rhsSuffix(int words, WDataOutP owp, WDataInP lwp, \
...
inline IData VL_CHANGEXOR_W(int words, WDataInP const lwp, WDataInP const rwp) VL_PURE {
    IData od = 0;
...
inline WDataOutP VL_NOT_W_##outputSuffix##lhsSuffix(int words, WDataOutP owp, WDataInP lwp) \
        VL_MT_SAFE { \
        const WDataOutP result = owp; \
        owp += VL_GET_TYPE_OFFSET(outputSuffix); \
        lwp += VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline IData VL_EQ_W_##lhsSuffix##rhsSuffix(int words, WDataInP lwp, WDataInP rwp) VL_PURE { \
        lwp = lwp + VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline IData VL_EQ_W_##rhsSuffix##T(int words, WDataInP const rwp, \
                                               const VlQueue<VlWide<N_Words>>& q) VL_PURE { \
        return VL_EQ_R_T##rhsSuffix(words, q, rwp); \
    } \
template <typename T> \
inline IData VL_EQ_W_##rhsSuffix##T(int words, WDataInP const rwp, VlQueue<T> q) \
        VL_PURE { \
        return VL_EQ_R_T##rhsSuffix(words, q, rwp); \
    } \
template <typename T> \
inline IData VL_EQ_R_T##rhsSuffix(int words, VlQueue<T> q, WDataInP rwp) VL_PURE { \
        EData nequal = 0; \
...
template <std::size_t N_Words> \
inline IData VL_EQ_R_T##rhsSuffix(int words, const VlQueue<VlWide<N_Words>>& q, \
...
inline int _vl_cmp_w_##lhsSuffix##rhsSuffix(int words, WDataInP lwp, WDataInP rwp) VL_PURE { \
        int i = words - 1; \
...
inline IData VL_GTS_III_TT(int lbits, IData lhs, IData rhs) VL_PURE {
...
inline IData VL_GTS_IQQ_TT(int lbits, QData lhs, QData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);
    return lhs_signed > rhs_signed;
}

inline IData VL_GTES_III_TT(int lbits, IData lhs, IData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);  // Q for gcc
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);  // Q for gcc
    return lhs_signed >= rhs_signed;
}
inline IData VL_GTES_IQQ_TT(int lbits, QData lhs, QData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);
    return lhs_signed >= rhs_signed;
}

inline IData VL_LTS_III_TT(int lbits, IData lhs, IData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);  // Q for gcc
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);  // Q for gcc
    return lhs_signed < rhs_signed;
}
inline IData VL_LTS_IQQ_TT(int lbits, QData lhs, QData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);
    return lhs_signed < rhs_signed;
}

inline IData VL_LTES_III_TT(int lbits, IData lhs, IData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);  // Q for gcc
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);  // Q for gcc
    return lhs_signed <= rhs_signed;
}
inline IData VL_LTES_IQQ_TT(int lbits, QData lhs, QData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);
    return lhs_signed <= rhs_signed;
}
...
inline int _vl_cmps_w_##lhsSuffix##rhsSuffix(int lbits, WDataInP lwp, WDataInP rwp) VL_PURE { \
        const int words = VL_WORDS_I(lbits); \
        int i = words - 1; \
        lwp = lwp + VL_GET_TYPE_OFFSET(lhsSuffix) + (i * VL_GET_TYPE_JUMP(lhsSuffix)); \
        rwp = rwp + VL_GET_TYPE_OFFSET(rhsSuffix) + (i * VL_GET_TYPE_JUMP(rhsSuffix)); \
...
inline WDataOutP VL_NEGATE_W_##outputSuffix##lhsSuffix(int words, WDataOutP owp, WDataInP lwp) VL_MT_SAFE { \
        const WDataOutP resultp = owp; \
        owp += VL_GET_TYPE_OFFSET(outputSuffix); \
        lwp += VL_GET_TYPE_OFFSET(lhsSuffix); \
        EData carry = 1; \
...
inline void VL_NEGATE_INPLACE_W_##suffix(int words, WDataOutP owp_lwp) VL_MT_SAFE { \
...
inline IData VL_DIV_III_TTT(int /*lbits*/, IData lhs, IData rhs) {
    return (rhs == 0) ? 0 : lhs / rhs;
}
inline QData VL_DIV_QQQ_TTT(int /*lbits*/, QData lhs, QData rhs) {
    return (rhs == 0) ? 0 : lhs / rhs;
}
...
inline IData VL_MODDIV_III_TTT(int /*lbits*/, IData lhs, IData rhs) {
    return (rhs == 0) ? 0 : lhs % rhs;
}
inline QData VL_MODDIV_QQQ_TTT(int /*lbits*/, QData lhs, QData rhs) {
    return (rhs == 0) ? 0 : lhs % rhs;
}
...
inline WDataOutP VL_ADD_W_##outputSuffix##lhsSuffix##rhsSuffix(int words, WDataOutP owp, WDataInP lwp, \
                                            WDataInP rwp) VL_MT_SAFE { \
    const WDataOutP result = owp; \
    owp += VL_GET_TYPE_OFFSET(outputSuffix); \
    lwp += VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline WDataOutP VL_SUB_W_##outputSuffix##lhsSuffix##rhsSuffix(int words, WDataOutP owp, WDataInP lwp, \
                                            WDataInP rwp) VL_MT_SAFE { \
    const WDataOutP result = owp; \
    owp += VL_GET_TYPE_OFFSET(outputSuffix); \
    lwp += VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline WDataOutP VL_MUL_W_##outputSuffix##lhsSuffix##rhsSuffix(int words, WDataOutP owp, WDataInP lwp, \
                                 WDataInP rwp) VL_MT_SAFE { \
    const WDataOutP result = owp; \
    owp += VL_GET_TYPE_OFFSET(outputSuffix); \
    lwp += VL_GET_TYPE_OFFSET(lhsSuffix); \
...
inline IData VL_MULS_III_TTT(int lbits, IData lhs, IData rhs) VL_PURE {
...
inline QData VL_MULS_QQQ_TTT(int lbits, QData lhs, QData rhs) VL_PURE {
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(64, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(64, lbits, rhs);
    // Signed int overflow is undefined behavior, so cast to unsigned first.
...
inline WDataOutP VL_MULS_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
...
inline IData VL_DIVS_III_TTT(int lbits, IData lhs, IData rhs) VL_PURE {
...
inline QData VL_DIVS_QQQ_TTT(int lbits, QData lhs, QData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs == 0)) return 0;
    // -MAX / -1 cannot be represented in twos complement, and will cause SIGFPE
...
inline IData VL_MODDIVS_III_TTT(int lbits, IData lhs, IData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs == 0)) return 0;
    if (VL_UNLIKELY(lhs == 0x80000000 && rhs == 0xffffffff)) return 0;
    const int32_t lhs_signed = VL_EXTENDS_II_TT(VL_IDATASIZE, lbits, lhs);
    const int32_t rhs_signed = VL_EXTENDS_II_TT(VL_IDATASIZE, lbits, rhs);
...
inline QData VL_MODDIVS_QQQ_TTT(int lbits, QData lhs, QData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs == 0)) return 0;
    if (VL_UNLIKELY(lhs == 0x8000000000000000ULL && rhs == 0xffffffffffffffffULL)) return 0;
    const int64_t lhs_signed = VL_EXTENDS_QQ_TT(VL_QUADSIZE, lbits, lhs);
    const int64_t rhs_signed = VL_EXTENDS_QQ_TT(VL_QUADSIZE, lbits, rhs);
...
inline WDataOutP VL_DIVS_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
        int lbits, WDataOutP owp, WDataInP const lwp, WDataInP const rwp) VL_MT_SAFE { \
        const int lwords = VL_WORDS_I(lbits); \
...
inline WDataOutP VL_MODDIVS_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
        int lbits, WDataOutP owp, WDataInP const lwp, WDataInP const rwp) VL_MT_SAFE { \
        const int lwords = VL_WORDS_I(lbits); \
        const EData lsign = VL_SIGN_E_T(lbits, *VL_GET_ELEM(lhsSuffix, lwp, lwords - 1)); \
        const EData rsign = VL_SIGN_E_T(lbits, *VL_GET_ELEM(rhsSuffix, rwp, lwords - 1)); \
...
inline IData VL_POW_III(int, int, int rbits, IData lhs, IData rhs) VL_PURE {
...
inline QData VL_POW_QQQ(int, int, int rbits, QData lhs, QData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs == 0)) return 1;
    if (VL_UNLIKELY(lhs == 0)) return 0;
    QData power = lhs;
    QData out = 1ULL;
...
inline void _vl_insert_II(CData& lhsr, IData ld, int hbit, int lbit, int rbits) VL_PURE {
...
inline void _vl_insert_II(SData& lhsr, IData ld, int hbit, int lbit, int rbits) VL_PURE {
    const IData cleanmask = VL_MASK_I(rbits);
    const IData insmask = (VL_MASK_I(hbit - lbit + 1)) << lbit;
    lhsr = (lhsr & ~insmask) | ((ld << lbit) & (insmask & cleanmask));
}
inline void _vl_insert_II(IData& lhsr, IData ld, int hbit, int lbit, int rbits) VL_PURE {
    const IData cleanmask = VL_MASK_I(rbits);
    const IData insmask = (VL_MASK_I(hbit - lbit + 1)) << lbit;
    lhsr = (lhsr & ~insmask) | ((ld << lbit) & (insmask & cleanmask));
}
inline void _vl_insert_QQ(QData& lhsr, QData ld, int hbit, int lbit, int rbits) VL_PURE {
...
inline void _vl_insert_WI_##outputSuffix(WDataOutP iowp, IData ld, int hbit, int lbit, \
...
inline void _vl_insert_IW_T##rhsSuffix(IData& lhsr, WDataInP const lwp, int hbit, \
...
inline void _vl_insert_WW_##outputSuffix##lhsSuffix(WDataOutP iowp, WDataInP const lwp, int hbit, int lbit, \
                                     int rbits = 0) VL_MT_SAFE { \
        const int hoffset = VL_BITBIT_E(hbit); \
        const int loffset = VL_BITBIT_E(lbit); \
        const int roffset = VL_BITBIT_E(rbits); \
...
inline void _vl_insert_WQ_##suffix(WDataOutP iowp, QData ld, int hbit, int lbit, \
                                          int rbits = 0) VL_MT_SAFE { \
        VlWide<VL_WQ_WORDS_E> lwp; \
        VL_SET_WQ_T(lwp, ld); \
...
inline IData VL_REPLICATE_III_TTT(int lbits, IData ld, IData rep) VL_PURE {
    IData returndata = ld;
...
inline QData VL_REPLICATE_QII_TTT(int lbits, IData ld, IData rep) VL_PURE {
    QData returndata = ld;
    for (unsigned i = 1; i < rep; ++i) {
        returndata = returndata << lbits;
...
inline WDataOutP VL_REPLICATE_WII_##outputSuffix##TT(int lbits, WDataOutP owp, \
...
inline WDataOutP VL_REPLICATE_WQI_##outputSuffix##TT(int lbits, WDataOutP owp, \
...
inline WDataOutP VL_REPLICATE_WWI_##outputSuffix##lhsSuffix##T( \
...
inline IData VL_STREAML_FAST_III(int lbits, IData ld, IData rd_log2) VL_PURE {
...
inline QData VL_STREAML_FAST_QQI(int lbits, QData ld, IData rd_log2) VL_PURE {
...
template <typename T>
inline IData VL_STREAMR_IRI(int lbits, VlQueue<T>& q, IData rd_log2) VL_PURE {
...
template <typename T>
inline IData VL_STREAMR_QRI(int lbits, VlQueue<T>& q, IData rd_log2) VL_PURE {
    QData value = 0;
    const size_t len = q.size();
...
template <typename T>
inline VlQueue<T> VL_STREAMR_RRI(int lbits, const VlQueue<T> q, IData rd) VL_MT_SAFE {
    return q;
}

inline VlQueue<std::string> VL_STREAMR_NRI(int lbits, const VlQueue<std::string> q,
                                           IData rd) VL_MT_SAFE {
    return q;
}
...
inline IData VL_STREAML_III(int lbits, IData ld, IData rd) VL_PURE {
    IData ret = 0;
...
template <typename T>
inline VlQueue<T> VL_STREAML_RRI(int lbitsIn, const VlQueue<T> q, IData rd) VL_MT_SAFE {
...
template <std::size_t N_Words>
inline VlQueue<VlWide<N_Words>> VL_STREAML_RRI(int lbitsIn, const VlQueue<VlWide<N_Words>> q,
                                               IData rd) VL_MT_SAFE {
...
inline IData VL_PACK_I_RI(int /*obits*/, int lbits, const VlQueue<SData>& q) {
    IData ret = 0;
    for (size_t i = 0; i < q.size(); ++i)
        ret |= static_cast<IData>(q.at(q.size() - 1 - i)) << (i * lbits);
    return ret;
...
inline IData VL_PACK_I_RI(int /*obits*/, int lbits, const VlQueue<IData>& q) {
    IData ret = 0;
...
inline IData VL_PACK_I_UI(int /*obits*/, int lbits, const VlUnpacked<CData, N_Depth>& q) {
    IData ret = 0;
...
template <std::size_t N_Depth>
inline IData VL_PACK_I_UI(int /*obits*/, int lbits, const VlUnpacked<SData, N_Depth>& q) {
    IData ret = 0;
    for (size_t i = 0; i < N_Depth; ++i)
        ret |= static_cast<IData>(q[N_Depth - 1 - i]) << (i * lbits);
    return ret;
...
template <std::size_t N_Depth>
inline IData VL_PACK_I_UI(int /*obits*/, int lbits, const VlUnpacked<IData, N_Depth>& q) {
    IData ret = 0;
...
inline QData VL_PACK_Q_RI(int /*obits*/, int lbits, const VlQueue<CData>& q) {
    QData ret = 0;
    for (size_t i = 0; i < q.size(); ++i)
...
inline QData VL_PACK_Q_RI(int /*obits*/, int lbits, const VlQueue<SData>& q) {
    QData ret = 0;
    for (size_t i = 0; i < q.size(); ++i)
        ret |= static_cast<QData>(q.at(q.size() - 1 - i)) << (i * lbits);
    return ret;
...
inline QData VL_PACK_Q_RI(int /*obits*/, int lbits, const VlQueue<IData>& q) {
    QData ret = 0;
    for (size_t i = 0; i < q.size(); ++i)
        ret |= static_cast<QData>(q.at(q.size() - 1 - i)) << (i * lbits);
    return ret;
...
template <std::size_t N_Depth>
inline QData VL_PACK_Q_UI(int /*obits*/, int lbits, const VlUnpacked<CData, N_Depth>& q) {
    QData ret = 0;
    for (size_t i = 0; i < N_Depth; ++i)
...
template <std::size_t N_Depth>
inline QData VL_PACK_Q_UI(int /*obits*/, int lbits, const VlUnpacked<SData, N_Depth>& q) {
    QData ret = 0;
    for (size_t i = 0; i < N_Depth; ++i)
        ret |= static_cast<QData>(q[N_Depth - 1 - i]) << (i * lbits);
    return ret;
...
template <std::size_t N_Depth>
inline QData VL_PACK_Q_UI(int /*obits*/, int lbits, const VlUnpacked<IData, N_Depth>& q) {
    QData ret = 0;
    for (size_t i = 0; i < N_Depth; ++i)
        ret |= static_cast<QData>(q[N_Depth - 1 - i]) << (i * lbits);
    return ret;
...
inline QData VL_PACK_Q_RQ(int /*obits*/, int lbits, const VlQueue<QData>& q) {
    QData ret = 0;
    for (size_t i = 0; i < q.size(); ++i) ret |= q.at(q.size() - 1 - i) << (i * lbits);
    return ret;
}

inline IData VL_PACK_I_RQ(int /*obits*/, int lbits, const VlQueue<QData>& q) {
    IData ret = 0;
    for (size_t i = 0; i < q.size(); ++i) ret |= q.at(q.size() - 1 - i) << (i * lbits);
    return ret;
}
...
template <std::size_t N_Words>
inline IData VL_PACK_I_RW(int /*obits*/, int lbits, const VlQueue<VlWide<N_Words>>& q) {
    IData ret = 0;
...
template <std::size_t N_Depth>
inline QData VL_PACK_Q_UQ(int /*obits*/, int lbits, const VlUnpacked<QData, N_Depth>& q) {
    QData ret = 0;
    for (size_t i = 0; i < N_Depth; ++i) ret |= q[N_Depth - 1 - i] << (i * lbits);
    return ret;
}
...
inline WDataOutP VL_CONCAT_WII_##outputSuffix##TT( \
...
inline WDataOutP VL_CONCAT_WWI_##outputSuffix##lhsSuffix##T( \
...
inline WDataOutP VL_CONCAT_WIW##outputSuffix##T##rhsSuffix( \
...
inline WDataOutP VL_CONCAT_WIQ_##outputSuffix##TT( \
...
inline WDataOutP VL_CONCAT_WQI_##outputSuffix##TT( \
...
inline WDataOutP VL_CONCAT_WQQ_##outputSuffix##TT( \
...
inline WDataOutP VL_CONCAT_WWQ_##outputSuffix##lhsSuffix##T( \
...
inline WDataOutP VL_CONCAT_WQW_##outputSuffix##T##rhsSuffix(int obits, int lbits, int rbits, WDataOutP owp, QData ld, \
                                      WDataInP const rwp) VL_MT_SAFE { \
    const int rwords = VL_WORDS_I(rbits); \
    VL_ASSIGN_W_##outputSuffix##rhsSuffix(rbits, owp, rwp); \
    VL_ZERO_OFFSET_W_##outputSuffix(obits - rbits, VL_GET_ELEM(outputSuffix, owp, rwords)); \
...
inline WDataOutP VL_CONCAT_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
...
inline void _vl_shiftl_inplace_w(int obits, WDataOutP iowp, IData rd /*1 or 4*/) VL_MT_SAFE {
    const int words = VL_WORDS_I(obits);
...
inline IData VL_SHIFTL_III_TTT(int /*obits*/, int, int, IData lhs, IData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_IDATASIZE)) return 0;
    return lhs << rhs;  // Small is common so not clean return
}
inline IData VL_SHIFTL_IIQ_TTT(int obits, int, int, IData lhs, QData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_IDATASIZE)) return 0;
    return VL_CLEAN_II(obits, obits, lhs << rhs);
}
inline QData VL_SHIFTL_QQI_TTT(int /*obits*/, int, int, QData lhs, IData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_QUADSIZE)) return 0;
    return lhs << rhs;  // Small is common so not clean return
}
inline QData VL_SHIFTL_QQQ_TTT(int obits, int, int, QData lhs, QData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_QUADSIZE)) return 0;
...
inline WDataOutP VL_SHIFTL_WWI_##outputSuffix##lhsSuffix##T( \
...
inline WDataOutP VL_SHIFTL_WWW_##outputSuffix##lhsSuffix##rhsSuffix(int obits, int lbits, int rbits, WDataOutP owp, \
...
inline WDataOutP VL_SHIFTL_WWQ_##outputSuffix##lhsSuffix##T(int obits, int lbits, int rbits, WDataOutP owp, \
...
inline IData VL_SHIFTL_IIW_TT##rhsSuffix(int obits, int, int rbits, IData lhs, WDataInP rwp) \
        VL_MT_SAFE { \
        rwp += VL_GET_TYPE_OFFSET(rhsSuffix); \
        const EData rwp0 = *rwp; \
        rwp += VL_GET_TYPE_JUMP(rhsSuffix); \
...
inline QData VL_SHIFTL_QQW_TT##rhsSuffix(int obits, int, int rbits, QData lhs, WDataInP rwp) \
        VL_MT_SAFE { \
        rwp += VL_GET_TYPE_OFFSET(rhsSuffix); \
        const EData rwp0 = *rwp; \
        rwp += VL_GET_TYPE_JUMP(rhsSuffix); \
...
// Important: Unlike most other funcs, the shift might well be a computed
// expression.  Thus consider this when optimizing.  (And perhaps have 2 funcs?)
inline IData VL_SHIFTR_III_TTT(int /*obits*/, int, int, IData lhs, IData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs >= VL_IDATASIZE)) return 0;
    return lhs >> rhs;
}
inline IData VL_SHIFTR_IIQ_TTT(int /*obits*/, int, int, IData lhs, QData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs >= VL_IDATASIZE)) return 0;
    return lhs >> rhs;
}
inline QData VL_SHIFTR_QQI_TTT(int /*obits*/, int, int, QData lhs, IData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs >= VL_QUADSIZE)) return 0;
    return lhs >> rhs;
}
inline QData VL_SHIFTR_QQQ_TTT(int /*obits*/, int, int, QData lhs, QData rhs) VL_PURE {
    if (VL_UNLIKELY(rhs >= VL_QUADSIZE)) return 0;
    return lhs >> rhs;
}
...
inline WDataOutP VL_SHIFTR_WWI_##outputSuffix##lhsSuffix##T( \
        int obits, int, int, WDataOutP owp, WDataInP lwp, IData rd) VL_MT_SAFE { \
        const WDataOutP resultp = owp; \
        owp += VL_GET_TYPE_OFFSET(outputSuffix); \
...
inline WDataOutP VL_SHIFTR_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
...
inline WDataOutP VL_SHIFTR_WWQ_##outputSuffix##lhsSuffix##T( \
        int obits, int lbits, int rbits, WDataOutP owp, WDataInP const lwp, QData rd) \
        VL_MT_SAFE { \
        if (VL_UNLIKELY(rd >> VL_IDATASIZE)) return VL_ZERO_W_##outputSuffix(obits, owp); \
...
inline IData VL_SHIFTR_IIW_TT##rhsSuffix(int obits, int, int rbits, IData lhs, \
                                                    WDataInP rwp) VL_PURE { \
        rwp = rwp + VL_GET_TYPE_OFFSET(rhsSuffix); \
        const EData rwp0 = *rwp; \
        rwp = rwp + VL_GET_TYPE_JUMP(rhsSuffix); \
...
inline QData VL_SHIFTR_QQW_TT##rhsSuffix(int obits, int, int rbits, QData lhs, \
                                                    WDataInP rwp) VL_PURE { \
        rwp = rwp + VL_GET_TYPE_OFFSET(rhsSuffix); \
        const EData rwp0 = *rwp; \
        rwp = rwp + VL_GET_TYPE_JUMP(rhsSuffix); \
...
inline IData VL_SHIFTRS_III_TTT(int obits, int lbits, int, IData lhs, IData rhs) VL_PURE {
...
inline QData VL_SHIFTRS_QQI_TTT(int obits, int lbits, int, QData lhs, IData rhs) VL_PURE {
...
inline IData VL_SHIFTRS_IQI_TTT(int obits, int lbits, int rbits, QData lhs, IData rhs) VL_PURE {
    return static_cast<IData>(VL_SHIFTRS_QQI_TTT(obits, lbits, rbits, lhs, rhs));
}

// clang-format off
#define VL_SHIFTRS_WWI_GEN(outputSuffix, lhsSuffix) \
inline WDataOutP VL_SHIFTRS_WWI_##outputSuffix##lhsSuffix##T( \
...
inline WDataOutP VL_SHIFTRS_WWW_##outputSuffix##lhsSuffix##rhsSuffix( \
        int obits, int lbits, int rbits, WDataOutP owp, WDataInP const lwp, WDataInP rwp) \
        VL_MT_SAFE { \
        rwp += VL_GET_TYPE_OFFSET(rhsSuffix); \
        const EData rwp0 = *rwp; \
...
inline WDataOutP VL_SHIFTRS_WWQ_##outputSuffix##lhsSuffix##T( \
        int obits, int lbits, int rbits, WDataOutP owp, WDataInP const lwp, QData rd) \
        VL_MT_SAFE { \
...
inline IData VL_SHIFTRS_IIW_TT##rhsSuffix(int obits, int lbits, int rbits, IData lhs, \
...
inline QData VL_SHIFTRS_QQW_TT##rhsSuffix(int obits, int lbits, int rbits, QData lhs, \
                                                     WDataInP const rwp) VL_PURE { \
        EData overshift = 0; /* Huge shift 1>>32 or more */ \
        for (int i = 1; i < VL_WORDS_I(rbits); ++i) overshift |= rwp[i]; \
        if (VL_UNLIKELY(overshift || rwp[0] >= static_cast<IData>(obits))) { \
...
inline IData VL_SHIFTRS_IIQ_TTT(int obits, int lbits, int rbits, IData lhs, QData rhs) VL_PURE {
    VlWide<VL_WQ_WORDS_E> rwp;
    VL_SET_WQ_T(rwp, rhs);
    return VL_SHIFTRS_IIW_TTT(obits, lbits, rbits, lhs, rwp);
}
inline QData VL_SHIFTRS_QQQ_TTT(int obits, int lbits, int rbits, QData lhs, QData rhs) VL_PURE {
    VlWide<VL_WQ_WORDS_E> rwp;
    VL_SET_WQ_T(rwp, rhs);
...
inline IData VL_BITSEL_IWII_T##lhsSuffix##TT(int lbits, WDataInP const lwp, IData rd) \
        VL_MT_SAFE { \
...
template <typename T>
inline IData VL_SEL_IRII_TTTT(int lbits, const VlQueue<T>& lhs, IData lsb,
...
template <std::size_t N_Words>
inline IData VL_SEL_IRII_TTTT(int lbits, const VlQueue<VlWide<N_Words>>& lhs, IData lsb,
                              IData width) VL_MT_SAFE {
    IData val = 0;
...
inline IData VL_SEL_IWII_T##lhsSuffix##TT(int lbits, WDataInP const lwp, IData lsb, \
                                                     IData width) VL_MT_SAFE { \
...
inline QData VL_SEL_QWII_T##lhsSuffix##TT(int lbits, WDataInP const lwp, IData lsb, \
                                                     IData width) VL_MT_SAFE { \
        const int msb = lsb + width - 1; \
        if (VL_UNLIKELY(msb >= lbits)) { \
            VL_IF_VX(lhsSuffix, \
...
inline WDataOutP VL_SEL_WWII_##outputSuffix##lhsSuffix##TT( \
...
template <typename T>
inline VlQueue<T> VL_CLONE_Q(const VlQueue<T>& from, int lbits, int srcElementBits,
                             int dstElementBits) {
    VlQueue<T> ret;
...
template <typename T>
inline VlQueue<T> VL_REVCLONE_Q(const VlQueue<T>& from, int lbits, int srcElementBits,
                                int dstElementBits) {
    VlQueue<T> ret;
...
template <typename T>
inline bool VL_GET_QUEUE_BIT(const VlQueue<T>& queue, int srcElementBits, size_t bitIndex) {
...
template <typename T>
inline void VL_SET_QUEUE_BIT(VlQueue<T>& queue, int dstElementBits, size_t bitIndex, bool value) {
    if (dstElementBits == 1) {
...
template <std::size_t N_Words>
inline bool VL_GET_QUEUE_BIT(const VlQueue<VlWide<N_Words>>& queue, int srcElementBits,
                             size_t bitIndex) {
    const size_t elemIdx = bitIndex / srcElementBits;
    if (VL_UNLIKELY(elemIdx >= queue.size())) return false;
...
template <std::size_t N_Words>
inline void VL_SET_QUEUE_BIT(VlQueue<VlWide<N_Words>>& queue, int dstElementBits, size_t bitIndex,
                             bool value) {
    const size_t elemIdx = bitIndex / dstElementBits;
    if (VL_UNLIKELY(elemIdx >= queue.size())) return;
...
template <typename T>
inline void VL_ZERO_INIT_QUEUE_ELEM(T& elem) {
    elem = 0;
}

template <std::size_t N_Words>
inline void VL_ZERO_INIT_QUEUE_ELEM(VlWide<N_Words>& elem) {
...
inline void VL_UNPACK_REVERSED(VlUnpacked<T_Value, N_Depth>& q) {
...
template <typename T_Value, std::size_t N_Depth>
inline VlUnpacked<T_Value, N_Depth> VL_PACK_REVERSED(const VlUnpacked<T_Value, N_Depth>& q) {
...
template <typename T, std::size_t N_Depth>
inline void VL_COPY_Q(VlQueue<T>& q, const VlUnpacked<T, N_Depth>& from, int lbits,
...
template <typename T, std::size_t N_Depth>
inline void VL_REVCOPY_Q(VlQueue<T>& q, const VlUnpacked<T, N_Depth>& from, int lbits,
                         int srcElementBits, int dstElementBits) {
    VlQueue<T> srcQ;
    srcQ.renew(N_Depth);
...
inline void VL_UNPACK_RI_I(int lbits, int rbits, VlQueue<CData>& q, IData from) {
...
inline void VL_UNPACK_RI_I(int lbits, int rbits, VlQueue<SData>& q, IData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) q.atWrite(size - 1 - i) = (from >> (i * lbits)) & mask;
...
inline void VL_UNPACK_RI_I(int lbits, int rbits, VlQueue<IData>& q, IData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) q.atWrite(size - 1 - i) = (from >> (i * lbits)) & mask;
...
inline void VL_UNPACK_RI_Q(int lbits, int rbits, VlQueue<CData>& q, QData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) q.atWrite(size - 1 - i) = (from >> (i * lbits)) & mask;
...
inline void VL_UNPACK_RI_Q(int lbits, int rbits, VlQueue<SData>& q, QData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) q.atWrite(size - 1 - i) = (from >> (i * lbits)) & mask;
...
inline void VL_UNPACK_RI_Q(int lbits, int rbits, VlQueue<IData>& q, QData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) q.atWrite(size - 1 - i) = (from >> (i * lbits)) & mask;
...
inline void VL_UNPACK_RQ_Q(int lbits, int rbits, VlQueue<QData>& q, QData from) {
    const size_t size = (rbits + lbits - 1) / lbits;
    q.renew(size);
...
inline void VL_UNPACK_RI_W(int lbits, int rbits, VlQueue<CData>& q, WDataInP rwp) {
...
inline void VL_UNPACK_RI_W(int lbits, int rbits, VlQueue<SData>& q, WDataInP rwp) {
    const int size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) {
...
inline void VL_UNPACK_RI_W(int lbits, int rbits, VlQueue<IData>& q, WDataInP rwp) {
    const int size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < size; ++i) {
...
inline void VL_UNPACK_RQ_W(int lbits, int rbits, VlQueue<QData>& q, WDataInP rwp) {
    const int size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    const QData mask = VL_MASK_Q(lbits);
    for (size_t i = 0; i < size; ++i) {
...
template <std::size_t N_Words>
inline void VL_UNPACK_RW_W(int lbits, int rbits, VlQueue<VlWide<N_Words>>& q, WDataInP rwp) {
    const int size = (rbits + lbits - 1) / lbits;
    q.renew(size);
    for (size_t i = 0; i < size; ++i) {
        // Extract from MSB to LSB: MSB goes to index 0
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UI_I(int lbits, int /*rbits*/, VlUnpacked<CData, N_Depth>& q, IData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <std::size_t N_Depth>
inline void VL_UNPACK_UI_I(int lbits, int /*rbits*/, VlUnpacked<SData, N_Depth>& q, IData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <std::size_t N_Depth>
inline void VL_UNPACK_UI_I(int lbits, int /*rbits*/, VlUnpacked<IData, N_Depth>& q, IData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <typename T_Sub, std::size_t N_Sub, std::size_t N_Depth>
inline void VL_UNPACK_UI_I(const int lbits, const int rbits,
                           VlUnpacked<VlUnpacked<T_Sub, N_Sub>, N_Depth>& q, const IData from) {
    const int sub_bits = VlUnpackedElements<VlUnpacked<T_Sub, N_Sub>>::count * lbits;
    for (size_t i = 0; i < N_Depth; ++i) {
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UI_Q(int lbits, int /*rbits*/, VlUnpacked<CData, N_Depth>& q, QData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <std::size_t N_Depth>
inline void VL_UNPACK_UI_Q(int lbits, int /*rbits*/, VlUnpacked<SData, N_Depth>& q, QData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <std::size_t N_Depth>
inline void VL_UNPACK_UI_Q(int lbits, int /*rbits*/, VlUnpacked<IData, N_Depth>& q, QData from) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <typename T_Sub, std::size_t N_Sub, std::size_t N_Depth>
inline void VL_UNPACK_UI_Q(const int lbits, const int rbits,
                           VlUnpacked<VlUnpacked<T_Sub, N_Sub>, N_Depth>& q, const QData from) {
    const int sub_bits = VlUnpackedElements<VlUnpacked<T_Sub, N_Sub>>::count * lbits;
    for (size_t i = 0; i < N_Depth; ++i) {
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UQ_Q(int lbits, int /*rbits*/, VlUnpacked<QData, N_Depth>& q, QData from) {
    const QData mask = VL_MASK_Q(lbits);
    for (size_t i = 0; i < N_Depth; ++i) q[i] = (from >> ((N_Depth - 1 - i) * lbits)) & mask;
}

template <typename T_Sub, std::size_t N_Sub, std::size_t N_Depth>
inline void VL_UNPACK_UI_W(const int lbits, const int rbits,
...
template <typename T_Sub, std::size_t N_Sub, std::size_t N_Depth>
inline void VL_UNPACK_UQ_W(const int lbits, const int rbits,
                           VlUnpacked<VlUnpacked<T_Sub, N_Sub>, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const int sub_bits = VlUnpackedElements<VlUnpacked<T_Sub, N_Sub>>::count * lbits;
    for (size_t i = 0; i < N_Depth; ++i) {
...
template <typename T_Sub, std::size_t N_Sub, std::size_t N_Depth>
inline void VL_UNPACK_UW_W(const int lbits, const int rbits,
                           VlUnpacked<VlUnpacked<T_Sub, N_Sub>, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const int sub_bits = VlUnpackedElements<VlUnpacked<T_Sub, N_Sub>>::count * lbits;
    for (size_t i = 0; i < N_Depth; ++i) {
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UI_W(int lbits, int rbits, VlUnpacked<CData, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i)
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UI_W(int lbits, int rbits, VlUnpacked<SData, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i)
        q[i] = VL_SEL_IWII_TTTT(rbits, rwp, bit_offset + (N_Depth - 1 - i) * lbits, lbits) & mask;
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UI_W(int lbits, int rbits, VlUnpacked<IData, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const IData mask = VL_MASK_I(lbits);
    for (size_t i = 0; i < N_Depth; ++i)
        q[i] = VL_SEL_IWII_TTTT(rbits, rwp, bit_offset + (N_Depth - 1 - i) * lbits, lbits) & mask;
...
template <std::size_t N_Depth>
inline void VL_UNPACK_UQ_W(int lbits, int rbits, VlUnpacked<QData, N_Depth>& q, WDataInP rwp,
                           const int bit_offset = 0) {
    const QData mask = VL_MASK_Q(lbits);
    for (size_t i = 0; i < N_Depth; ++i)
...
template <std::size_t N_Depth, std::size_t N_Words>
inline void VL_UNPACK_UW_W(int lbits, int rbits, VlUnpacked<VlWide<N_Words>, N_Depth>& q,
...
inline QData VL_RTOIROUND_Q_D(double lhs) VL_PURE {
...
inline IData VL_RTOIROUND_I_D(double lhs) VL_PURE {
    return static_cast<IData>(VL_RTOIROUND_Q_D(lhs));
}
inline WDataOutP VL_RTOIROUND_W_D(int obits, WDataOutP owp, double lhs) VL_MT_SAFE {
    // IEEE format: [63]=sign [62:52]=exp+1023 [51:0]=mantissa
    // This does not need to support subnormals as they are sub-integral
    lhs = VL_ROUND(lhs);
...
inline void VL_ASSIGNSEL_II_TT(int rbits, int obits, int lsb, CData& lhsr, IData rhs) VL_PURE {
    _vl_insert_II(lhsr, rhs, lsb + obits - 1, lsb, rbits);
}
inline void VL_ASSIGNSEL_II_TT(int rbits, int obits, int lsb, SData& lhsr, IData rhs) VL_PURE {
    _vl_insert_II(lhsr, rhs, lsb + obits - 1, lsb, rbits);
}
inline void VL_ASSIGNSEL_II_TT(int rbits, int obits, int lsb, IData& lhsr, IData rhs) VL_PURE {
    _vl_insert_II(lhsr, rhs, lsb + obits - 1, lsb, rbits);
}
inline void VL_ASSIGNSEL_QI_TT(int rbits, int obits, int lsb, QData& lhsr, IData rhs) VL_PURE {
    _vl_insert_QQ(lhsr, rhs, lsb + obits - 1, lsb, rbits);
}
inline void VL_ASSIGNSEL_QQ_TT(int rbits, int obits, int lsb, QData& lhsr, QData rhs) VL_PURE {
    _vl_insert_QQ(lhsr, rhs, lsb + obits - 1, lsb, rbits);
}
...
inline void VL_ASSIGNSEL_WI_##lhsSuffix##T(int rbits, int obits, int lsb, WDataOutP iowp, IData rhs) \
        VL_MT_SAFE { \
...
inline void VL_ASSIGNSEL_WQ_##lhsSuffix##T(int rbits, int obits, int lsb, \
...
inline void VL_ASSIGNSEL_WW_##lhsSuffix##rhsSuffix( \
...
inline void VL_SELASSIGN_II_TT(int rbits, int obits, CData& lhsr, IData rhs, int roffset) VL_PURE {
    _vl_insert_II(lhsr, rhs >> roffset, obits - 1, 0, rbits);
}
inline void VL_SELASSIGN_II_TT(int rbits, int obits, SData& lhsr, IData rhs, int roffset) VL_PURE {
    _vl_insert_II(lhsr, rhs >> roffset, obits - 1, 0, rbits);
}
inline void VL_SELASSIGN_II_TT(int rbits, int obits, IData& lhsr, IData rhs, int roffset) VL_PURE {
    _vl_insert_II(lhsr, rhs >> roffset, obits - 1, 0, rbits);
}
inline void VL_SELASSIGN_IQ_TT(int rbits, int obits, CData& lhsr, QData rhs, int roffset) VL_PURE {
...
inline void VL_SELASSIGN_IQ_TT(int rbits, int obits, SData& lhsr, QData rhs, int roffset) VL_PURE {
    // it will be truncated to right CData mask
...
inline void VL_SELASSIGN_IQ_TT(int rbits, int obits, IData& lhsr, QData rhs, int roffset) VL_PURE {
    const IData cleanmask = VL_MASK_I(rbits);
    const IData insmask = VL_MASK_I(obits);
    lhsr = (lhsr & ~insmask) | (static_cast<IData>(rhs >> roffset) & (insmask & cleanmask));
}

inline void VL_SELASSIGN_QQ_TT(int rbits, int obits, QData& lhsr, QData rhs, int roffset) VL_PURE {
    _vl_insert_QQ(lhsr, rhs >> roffset, obits - 1, 0, rbits);
}

// clang-format off
#define VL_SELASSIGN_IW_GEN(rhsSuffix) \
inline void VL_SELASSIGN_IW_T##rhsSuffix(int rbits, int obits, CData& lhsr, \
...
// clang-format off
#define VL_SELASSIGN_IW_GEN(rhsSuffix) \
inline void VL_SELASSIGN_IW_T##rhsSuffix(int rbits, int obits, SData& lhsr, \
                                                    WDataInP const rhs, int roffset) VL_MT_SAFE { \
        IData l = static_cast<IData>(lhsr); \
        _vl_insert_IW_T##rhsSuffix(l, rhs, roffset + obits - 1, roffset, rbits); \
...
// clang-format off
#define VL_SELASSIGN_IW_GEN(rhsSuffix) \
inline void VL_SELASSIGN_IW_T##rhsSuffix(int rbits, int obits, IData& lhsr, \
                                                    WDataInP const rhs, int roffset) VL_MT_SAFE { \
...
inline void VL_SELASSIGN_QW_T##rhsSuffix(int rbits, int obits, QData& lhsr, \
                                                    WDataInP const rhs, int roffset) VL_MT_SAFE { \
...
inline void VL_SELASSIGN_WW_##lhsSuffix##rhsSuffix( \
...
inline WDataOutP VL_CONST_W_T(const int obits, WDataOutP const o,
...
inline WDataOutP VL_CONST_W_##outputSuffix( \
...
inline IData VL_VALUEPLUSARGS_IND(int rbits, const std::string& ld, double& rdr) VL_MT_SAFE {
    ...
    if (got) rdr = VL_CVT_D_Q(VL_SET_QW_T(rwp));
    return got;
}
