...
std::string _vl_vsformat_time(char* tmp, double ld, bool left, size_t width) {
    ...
    if (!fracDigits) {
        ...
        digits = sprintf(tmp, "%" VL_PRI64 "u.%0*" VL_PRI64 "u%s", whole,
                         fracDigits, fraction, suffix.c_str());
    }
...
const char* Verilated::timeprecisionString() VL_MT_SAFE {
...
void VerilatedImp::timeFormatUnits(int value) VL_MT_SAFE {
    s_s.m_ser.m_timeFormatUnits = value;
}
void VerilatedImp::timeFormatPrecision(int value) VL_MT_SAFE {
    s_s.m_ser.m_timeFormatPrecision = value;
}
void VerilatedImp::timeFormatWidth(int value) VL_MT_SAFE {
    s_s.m_ser.m_timeFormatWidth = value;
}
...
void VerilatedScope::configure(VerilatedSyms* symsp, const char* prefixp,
                               ...
                               vlsint8_t timeunit, const Type type) VL_MT_UNSAFE {
