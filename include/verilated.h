...
static inline IData VL_SHIFTL_IIQ(int obits, IData lhs, QData rhs) VL_MT_SAFE {
...
static inline QData VL_SHIFTL_QQQ(int obits, QData lhs, QData rhs) VL_MT_SAFE {
...
static inline IData VL_SHIFTR_IIQ(int obits, int, IData lhs, QData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_IDATASIZE)) return 0;
    return VL_CLEAN_QQ(obits, obits, lhs >> rhs);
}
static inline QData VL_SHIFTR_QQQ(int obits, int, QData lhs, QData rhs) VL_MT_SAFE {
    if (VL_UNLIKELY(rhs >= VL_QUADSIZE)) return 0;
    return VL_CLEAN_QQ(obits, obits, lhs >> rhs);
}
