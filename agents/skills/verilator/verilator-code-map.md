...
| Symptom | File | Function/Class |
|---------|------|----------------|
| Function emission | `V3EmitCFunc.cpp` | `EmitCFuncVisitor::visit(AstFunc*)`, `emitFunc()` |
| Class emission | `V3EmitCClass.cpp` | `EmitCClassVisitor::visit(AstClass*)`, `emitClass()` |
| Module emission | `V3EmitC.cpp` | `EmitCVisitor::visit(AstModule*)`, `emitModule()` |
| Statement emission | `V3EmitC.cpp` | `EmitCVisitor::visit(AstNodeStmt*)`, `emitStmt()` |
| Expression emission | `V3EmitC.cpp` | `EmitCVisitor::visit(AstNodeExpr*)`, `emitExpr()` |
