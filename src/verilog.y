...
tableLine<udpTableLinep>:
        ...
        |       tableIField tablelVal yaTABLELRSEP tableOField yaTABLELINEEND { $$ = new AstUdpTableLine{$<fl>1, addNextNull($1, $2), $4, AstUdpTableLine::UDP_COMB}; }
        ...
        |       tableIField tablelVal yaTABLELRSEP tableOField yaTABLESEP yaTABLELRSEP tableOField yaTABLELINEEND { $$ = new AstUdpTableLine{$<fl>1, addNextNull($1, $2), $4, $7, AstUdpTableLine::UDP_SEQUENT}; }
        ;
