...
V3VpiLazyContext& AstNetlist::createVpiLazyContext() {
    V3VpiLazy::deleteContext(m_vpiLazyContextp);
    m_vpiLazyContextp = V3VpiLazy::newContext();
    return *m_vpiLazyContextp;
}
...
AstNetlist::~AstNetlist() { V3VpiLazy::deleteContext(m_vpiLazyContextp); }
...
void AstVar::combineType(const AstVar* otherp) {
    ...
    if (m_vpiLazyRole == VVpiLazyRole::NONE) {
        ...
        UASSERT_OBJ(otherp->m_vpiLazyRole == VVpiLazyRole::NONE
