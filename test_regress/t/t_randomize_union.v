...
class SimpleUnionConstrainedTest;
  ...
  constraint union_constraint {union_instance.bits[11:0] inside {[0 : 4095]};}
endclass
...
class StructInUnionConstrainedTest;
  ...
  constraint union_constraint {union_instance.inner_bits inside {[0 : 4095]};}
endclass
...
class UnionInUnionConstrainedTest;
  ...
  constraint union_constraint {union_instance.outer_bits inside {[0 : 4095]};}
endclass
...
module t_randomize_union;
  ...
  initial begin
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display("SimpleUnion (Constrained): int_value: %b, bits: %b",
               test_simple_union_constrained.union_instance.int_value,
               test_simple_union_constrained.union_instance.bits);
    end
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display("SimpleUnion (Unconstrained): int_value: %b, bits: %b",
               test_simple_union_unconstrained.union_instance.int_value,
               test_simple_union_unconstrained.union_instance.bits);
    end
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display("StructInUnion (Constrained): struct.a: %b, struct.b: %b, inner_bits: %b",
               test_struct_in_union_constrained.union_instance.struct_fields.field_a,
               test_struct_in_union_constrained.union_instance.struct_fields.field_b,
               test_struct_in_union_constrained.union_instance.inner_bits);
    end
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display("StructInUnion (Unconstrained): struct.a: %b, struct.b: %b, inner_bits: %b",
               test_struct_in_union_unconstrained.union_instance.struct_fields.field_a,
               test_struct_in_union_unconstrained.union_instance.struct_fields.field_b,
               test_struct_in_union_unconstrained.union_instance.inner_bits);
    end
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display("UnionInUnion (Constrained): outer_bits: %b, inner_union.struct: %b, b: %b",
               test_union_in_union_constrained.union_instance.outer_bits,
               test_union_in_union_constrained.union_instance.inner_union.struct_fields.field_a,
               test_union_in_union_constrained.union_instance.inner_union.struct_fields.field_b);
    end
    ...
    repeat (10) begin
      ...
      if (success != 1) $stop;
      $display(
          "UnionInUnion (Unconstrained): outer_bits: %b, inner_union.struct: %b, inner_union.inner_bits: %b",
          test_union_in_union_unconstrained.union_instance.outer_bits,
          test_union_in_union_unconstrained.union_instance.inner_union.struct_fields,
          test_union_in_union_unconstrained.union_instance.inner_union.inner_bits);
    end
    $write("*-* All Finished *-*\n");
    $finish;
  end
