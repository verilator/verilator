...
test.file_grep(test.stats, r'VPI, lazy reconstructed\s+(\d+)', 22)
test.file_grep(test.stats, r'VPI, lazy reconstructed members\s+(\d+)', 20)
test.file_grep(test.stats, r'VPI, lazy cross-scope copy descriptors\s+(\d+)', 2)
test.file_grep(test.stats, r'VPI, lazy group bail, cross-scope cone\s+(\d+)', 4)
