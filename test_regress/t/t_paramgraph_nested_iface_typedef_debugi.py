...
# Debug-variant of t_paramgraph_nested_iface_typedef: enables IfaceCapture
# debug output and verifies dead-ref fixup and propagateClone messages.
...
test.file_grep(test.compile_log_filename, r"iface capture finalizeCapture")
