...
module t (
  ...
  for (genvar_i = 0; genvar_i < 2; genvar_i++) begin : the_gen
    ...
    always_comb gen_array = '{genvar_i: 32'habcd, default: 0};
  ...
  always_comb enum_array = '{ENUM_A: 32'h1234, ENUM_B: 32'h7777, ENUM_C: 32'ha5a5, default: 0};
  ...
  import some_pkg::*;
  always_comb package_array = '{FOO: 32'h9876, BAR: 32'h1212, QUX: 32'h5432, default: 0};
