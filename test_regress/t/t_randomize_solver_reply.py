...
runs = [
    ...
    ('err_reply', 5, 15),  # error in place of an intermediate phase value reply
    ('err_reply', 7, 15),  # error in place of the final phased model
    ('err_reply', 15, 16),  # error in place of the unsat core
    ('err_reply', 34, 16),  # error in place of the unsat assumptions
