#!/usr/bin/env python3
# DESCRIPTION: Verilator: Finish propagation across timing boundaries without expression lifting
#
...
test.top_filename = 't/t_finish_timing_propagation.v'

modes = ('begin', 'constructor', 'join', 'join_any', 'join_none', 'wait_fork', 'delay', 'event',
         'wait_loop', 'lambda')

test.compile(verilator_flags2=[
    '--binary', '--stats', '--timing', '-Wno-ASSIGNEQEXPR', '-Wno-FUNCTIMECTL', '-fno-lift-expr'
],
