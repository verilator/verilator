...
test.compile(verilator_flags2=["-sc --pins-sc-uint-bool --trace-vcd --exe", test.pli_filename],
             make_main=False)
...
hgrep(r'sc_core::sc_in<sc_dt::sc_uint<1>\s>\s+&i1;')
...
hgrep(r'sc_core::sc_out<sc_dt::sc_uint<1>\s>\s+&o1;')
