...
module t (
  ...
  logic [30:0]          exp_vec_out;            // From reference of t_embed1_child.v
  logic [123:0]         exp_wide_out;           // From reference of t_embed1_child.v
  bit                   got_bit_out;            // From test of t_embed1_wrap.v
  bit                   got_did_init_out;       // From test of t_embed1_wrap.v
  bit [30:0]            got_vec_out;            // From test of t_embed1_wrap.v
  bit [123:0]           got_wide_out;           // From test of t_embed1_wrap.v
  // End of automatics
  ...
  /* t_embed1_child AUTO_TEMPLATE(
      ...
      .is_ref (1'b1));
    */
  t_embed1_child reference (  /*AUTOINST*/
                            // Outputs
