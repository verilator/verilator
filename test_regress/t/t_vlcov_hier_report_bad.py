...
run_vlcov(test,
          log=log,
          tmp_log=tmp_log,
          label="verilator_coverage --report unknown t/t_cover_hier.out",
...
run_vlcov(test,
          log=log,
          tmp_log=tmp_log,
          label="verilator_coverage --report summary,unknown t/t_cover_hier.out",
...
run_vlcov(test,
          log=log,
          tmp_log=tmp_log,
          label="verilator_coverage --report hierarchy missing.dat",
