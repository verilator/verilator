...
int mon_check_props() {
    ...
    static struct params values[]
        = {{"onebit", {1, vpiNoDirection, 1, vpiReg}, {0, 0, 0, 0}},
           ...
           {"onetwo",
            {2, vpiNoDirection, 1, TestSimulator::is_icarus() ? vpiMemory : vpiRegArray},
            {0, 0, 0, 0}},
           {"fourthreetwoone",
            {2, vpiNoDirection, 0, TestSimulator::is_icarus() ? vpiMemory : vpiRegArray},
            {2, vpiNoDirection, 0, TestSimulator::is_icarus() ? vpiMemoryWord : vpiReg}},
