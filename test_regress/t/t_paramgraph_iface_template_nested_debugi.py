...
# Debug-variant of t_paramgraph_iface_template_nested: enables IfaceCapture
# debug output and verifies propagateClone and capture messages for deeply
# nested interface typedef chains.
