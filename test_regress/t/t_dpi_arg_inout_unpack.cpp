...
template <typename T>
bool update_1d1(T* v) {
    if (!compare<T>(v[0], 52)) return false;
    ++v[0];
    return true;
}
template <typename T>
bool update_2d1(T* v) {
    if (!compare<T>(v[0], 53)) return false;
    ++v[0];
    return true;
}
template <typename T>
bool update_3d1(T* v) {
    if (!compare<T>(v[0], 54)) return false;
    ++v[0];
    return true;
}
...
bool update_1d1_scalar(svScalar* v) {
    if (!compare_scalar(v[0], sv_0)) return false;
    v[0] = sv_1;
    return true;
}
bool update_2d1_scalar(svScalar* v) {
    if (!compare_scalar(v[0], sv_1)) return false;
    v[0] = sv_0;
    return true;
}
bool update_3d1_scalar(svScalar* v) {
    if (!compare_scalar(v[0], sv_0)) return false;
    v[0] = sv_1;
    return true;
}
...
template <typename T>
bool update_1d1(T* v, int bitwidth) {
    const int unit = (bitwidth + 31) / 32;
    if (!compare(v, 52, bitwidth)) return false;
    set_uint(v, 53, bitwidth);
    return true;
}
template <typename T>
bool update_2d1(T* v, int bitwidth) {
    const int unit = (bitwidth + 31) / 32;
    if (!compare(v, 53, bitwidth)) return false;
    set_uint(v, 54, bitwidth);
    return true;
}
template <typename T>
bool update_3d1(T* v, int bitwidth) {
    const int unit = (bitwidth + 31) / 32;
    if (!compare(v, 54, bitwidth)) return false;
    set_uint(v, 55, bitwidth);
    return true;
}
...
bool check_2d1(const T (&v)[1][1]) {
    return compare<T>(v[0][0], 54);
}
template <typename T>
bool check_3d1(const T (&v)[1][1][1]) {
    return compare<T>(v[0][0][0], 55);
}
...
template <typename T, size_t N>
bool check_1d1(const T (&v)[1][N], unsigned int bitwidth) {
    return compare(v[0], 53, bitwidth);
}
template <typename T, size_t N>
bool check_2d1(const T (&v)[1][1][N], unsigned int bitwidth) {
    return compare(v[0][0], 54, bitwidth);
}
template <typename T, size_t N>
bool check_3d1(const T (&v)[1][1][1][N], unsigned int bitwidth) {
    return compare(v[0][0][0], 55, bitwidth);
}
...
void i_byte_1d1(char* v) {
    if (!update_1d1(v)) stop();
}
void i_byte_2d1(char* v) {
    if (!update_2d1(v)) stop();
}
void i_byte_3d1(char* v) {
    if (!update_3d1(v)) stop();
}
...
void i_byte_unsigned_1d1(unsigned char* v) {
    if (!update_1d1(v)) stop();
}
void i_byte_unsigned_2d1(unsigned char* v) {
    if (!update_2d1(v)) stop();
}
void i_byte_unsigned_3d1(unsigned char* v) {
    if (!update_3d1(v)) stop();
}
...
void i_shortint_1d1(short* v) {
    if (!update_1d1(v)) stop();
}
void i_shortint_2d1(short* v) {
    if (!update_2d1(v)) stop();
}
void i_shortint_3d1(short* v) {
    if (!update_3d1(v)) stop();
}
...
void i_shortint_unsigned_1d1(unsigned short* v) {
    if (!update_1d1(v)) stop();
}
void i_shortint_unsigned_2d1(unsigned short* v) {
    if (!update_2d1(v)) stop();
}
void i_shortint_unsigned_3d1(unsigned short* v) {
    if (!update_3d1(v)) stop();
}
...
void i_int_1d1(int* v) {
    if (!update_1d1(v)) stop();
}
void i_int_2d1(int* v) {
    if (!update_2d1(v)) stop();
}
void i_int_3d1(int* v) {
    if (!update_3d1(v)) stop();
}
...
void i_int_unsigned_1d1(unsigned int* v) {
    if (!update_1d1(v)) stop();
}
void i_int_unsigned_2d1(unsigned int* v) {
    if (!update_2d1(v)) stop();
}
void i_int_unsigned_3d1(unsigned int* v) {
    if (!update_3d1(v)) stop();
}
...
void i_longint_1d1(sv_longint_t* v) {
    if (!update_1d1(v)) stop();
}
void i_longint_2d1(sv_longint_t* v) {
    if (!update_2d1(v)) stop();
}
void i_longint_3d1(sv_longint_t* v) {
    if (!update_3d1(v)) stop();
}
...
void i_longint_unsigned_1d1(sv_longint_unsigned_t* v) {
    if (!update_1d1(v)) stop();
}
void i_longint_unsigned_2d1(sv_longint_unsigned_t* v) {
    if (!update_2d1(v)) stop();
}
void i_longint_unsigned_3d1(sv_longint_unsigned_t* v) {
    if (!update_3d1(v)) stop();
}
...
void i_time_1d1(svLogicVecVal* v) {
    if (!update_1d1(v, 64)) stop();
}
void i_time_2d1(svLogicVecVal* v) {
    if (!update_2d1(v, 64)) stop();
}
void i_time_3d1(svLogicVecVal* v) {
    if (!update_3d1(v, 64)) stop();
}
#endif
...
void i_integer_1d1(svLogicVecVal* v) {
    if (!update_1d1(v, 32)) stop();
}
void i_integer_2d1(svLogicVecVal* v) {
    if (!update_2d1(v, 32)) stop();
}
void i_integer_3d1(svLogicVecVal* v) {
    if (!update_3d1(v, 32)) stop();
}
#endif
...
void i_real_1d1(double* v) { update_1d1(v); }
void i_real_2d1(double* v) { update_2d1(v); }
void i_real_3d1(double* v) { update_3d1(v); }
...
void i_shortreal_1d1(float* v) { update_1d1(v); }
void i_shortreal_2d1(float* v) { update_2d1(v); }
void i_shortreal_3d1(float* v) { update_3d1(v); }
#endif
...
void i_chandle_1d1(void** v) {
    if (v[0]) stop();
    v[0] = get_non_null();
}
void i_chandle_2d1(void** v) {
    if (v[0]) stop();
    v[0] = get_non_null();
}
void i_chandle_3d1(void** v) {
    if (v[0]) stop();
    v[0] = get_non_null();
}
...
void i_string_1d1(const char** v) {
    static const char s0[] = "53";
    if (!compare<std::string>(v[0], "52")) stop();
    v[0] = s0;
}
void i_string_2d1(const char** v) {
    static const char s0[] = "54";
    if (!compare<std::string>(v[0], "53")) stop();
    v[0] = s0;
}
void i_string_3d1(const char** v) {
    static const char s0[] = "55";
    if (!compare<std::string>(v[0], "54")) stop();
    v[0] = s0;
}
...
void i_bit1_1d1(svBit* v) { update_1d1_scalar(v); }
void i_bit1_2d1(svBit* v) { update_2d1_scalar(v); }
void i_bit1_3d1(svBit* v) { update_3d1_scalar(v); }
...
void i_bit7_1d1(svBitVecVal* v) { update_1d1(v, 7); }
void i_bit7_2d1(svBitVecVal* v) { update_2d1(v, 7); }
void i_bit7_3d1(svBitVecVal* v) { update_3d1(v, 7); }
...
void i_bit121_1d1(svBitVecVal* v) { update_1d1(v, 121); }
void i_bit121_2d1(svBitVecVal* v) { update_2d1(v, 121); }
void i_bit121_3d1(svBitVecVal* v) { update_3d1(v, 121); }
...
void i_logic1_1d1(svLogic* v) { update_1d1_scalar(v); }
void i_logic1_2d1(svLogic* v) { update_2d1_scalar(v); }
void i_logic1_3d1(svLogic* v) { update_3d1_scalar(v); }
...
void i_logic7_1d1(svLogicVecVal* v) { update_1d1(v, 7); }
void i_logic7_2d1(svLogicVecVal* v) { update_2d1(v, 7); }
void i_logic7_3d1(svLogicVecVal* v) { update_3d1(v, 7); }
...
void i_logic121_1d1(svLogicVecVal* v) { update_1d1(v, 121); }
void i_logic121_2d1(svLogicVecVal* v) { update_2d1(v, 121); }
void i_logic121_3d1(svLogicVecVal* v) { update_3d1(v, 121); }
...
void i_pack_struct_1d1(svLogicVecVal* v) { update_1d1(v, 7); }
void i_pack_struct_2d1(svLogicVecVal* v) { update_2d1(v, 7); }
void i_pack_struct_3d1(svLogicVecVal* v) { update_3d1(v, 7); }
...
void i_unpack_struct_1d1(unpack_struct_t* v) {
    if (!compare(v[0].val, 52, 121)) stop();
    set_uint(v[0].val, 53, 121);
}
void i_unpack_struct_2d(unpack_struct_t* v) {
    if (!compare(v[0].val, 53, 121)) stop();
    set_uint(v[0].val, 54, 121);
}
void i_unpack_struct_3d(unpack_struct_t* v) {
    if (!compare(v[0].val, 54, 121)) stop();
    set_uint(v[0].val, 55, 121);
#endif
    ...
    void check_exports() {
        ...
        }
        {
            ...
            e_chandle_1d1(&array[0][0][0]);
            if (array[0][0][0]) stop();
            array[0][0][0] = get_non_null();
            e_chandle_2d1(&array[0][0][0]);
            if (array[0][0][0]) stop();
            array[0][0][0] = get_non_null();
            e_chandle_3d1(&array[0][0][0]);
            if (array[0][0][0]) stop();
        }
        ...
        }
        {
            ...
            if (!compare<std::string>(array[0][0][0], "53")) stop();
            array[0][0][0] = "53";
            e_string_2d1(&array[0][0][0]);
            if (!compare<std::string>(array[0][0][0], "54")) stop();
            array[0][0][0] = "54";
            e_string_3d1(&array[0][0][0]);
            if (!compare<std::string>(array[0][0][0], "55")) stop();
        }
        ...
        {
            unpack_struct_t array[1][1][1];
            set_uint(array[0][0][0].val, 52, 121);
            e_unpack_struct_1d1(&array[0][0][0]);
            if (!compare(array[0][0][0].val, 53, 121)) stop();
            set_uint(array[0][0][0].val, 53, 121);
            e_unpack_struct_2d1(&array[0][0][0]);
            if (!compare(array[0][0][0].val, 53, 121)) stop();
            set_uint(array[0][0][0].val, 53, 121);
            e_unpack_struct_3d1(&array[0][0][0]);
            if (!compare(array[0][0][0].val, 53, 121)) stop();
        }
#endif
    }
