...
test.compile(verilator_flags2=[
    '--binary', '-j', '8', '--debug', '--decorations', 'node', '--MAKEFLAGS', '-k', '--Wall', '',
    '-Wno-fatal', '--Wno-WIDTH', '-Wno-MISINDENT', '-Wno-REALCVT', '-Wno-CASTCONST',
    ...
    '--Wno-MISINDENT', '--Wno-MULTITOP', '--Wno-NONSTD', '--Wno-SHORTREAL', '--timescale',
    '1ns/1ns', '--vpi', '-CFLAGS', '-DVERILATOR',
    't/t_0_uvm_dpi/uvm_dpi.cc'
])
