...
# CRLF, chatter, wrapped replies, multi-line errors, and unsupported must all parse cleanly
for mode in ('crlf', 'success', 'multiline', 'err_multiline', 'unsupported_once'):
