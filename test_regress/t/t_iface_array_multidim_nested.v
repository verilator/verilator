// DESCRIPTION: Verilator: multi-dim iface array where outer iface contains an inner iface.
//
// Exercises composition: outer_if oarr[A][B]() where outer_if contains a single
// inner_if instance. Access oarr[i][j].inner.data.
//
