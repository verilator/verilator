...
test.file_grep(merged, r"cg_guards\.selected\.low_bit.*' 4")
test.file_grep(merged, r"cg_guards\.selected\.high_bit.*' 4")
test.file_grep(merged, r"cg_guards\.selected\.selected_bit.*' 3")
test.file_grep(merged, r"cg_guards\.selected\.low_slice.*' 6")
test.file_grep(merged, r"cg_guards\.selected\.whole_vector.*' 7")
...
test.file_grep(merged, r"cg_hit_words\.selected\.high.*' 4")
test.file_grep(merged, r"cg_hit_words\.selected\.ends.*' 4")
test.file_grep(merged, r"cg_hit_words\.selected\.b1_x_b0.*' 4")
test.file_grep(merged, r"cg_hit_words\.selected\.b1_x_b1.*' 3")
test.file_grep(merged, r"cg_hit_words\.whole\.all_values.*' 10")
