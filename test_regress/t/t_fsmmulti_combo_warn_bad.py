...
test.file_grep(
    ...
    r'%Warning-FSMMULTI: t/t_fsmmulti_combo_warn_bad.v:31:5: FSM coverage: multiple supported '
    r'transition candidates found in the same combinational always block. Only the first '
