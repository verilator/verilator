...
`include "portdecl.vh" // Boilerplate generated by t_dfg_peephole.py
   ...
   `signal(PUSH_REDUCTION_THROUGH_BITWISE_AND, &((rand_a[0] ? rand_a : 0) | (rand_b[0] ? rand_b : 0)));
   `signal(PUSH_REDUCTION_THROUGH_BITWISE_OR, |((rand_a[0] ? rand_a : 0) | (rand_b[0] ? rand_b : 0)));
   `signal(PUSH_REDUCTION_THROUGH_BITWISE_XOR, ^((rand_a[0] ? rand_a : 0) | (rand_b[0] ? rand_b : 0)));
