...
All_Scenarios = {
    ...
    'vlt': [
        'linter', 'simulator', 'simulator_st', 'vlt_all', 'vlt', 'linter2', 'simulator2',
        'simulator_st2', 'vlt_all2', 'vlt2'
    ],
    'vlt4': [
        'linter', 'simulator', 'simulator_st', 'vlt_all', 'vlt', 'linter4', 'simulator4',
        'simulator_st4', 'vlt_all4', 'vlt4'
    ],
    'vltmt': ['simulator', 'vlt_all', 'vltmt', 'simulator2', 'vlt_all2', 'vltmt2'],
    'vltmt4': ['simulator', 'vlt_all', 'vltmt', 'simulator4', 'vlt_all4', 'vltmt4'],
    # yapf: enable
}
...
class VlTest:
    ...
    def __init__(self, py_filename, scenario, running_id):
        ...
        self.fourstate_capable = True  # This is only a temporary indicator
        self.fourstate_nowarn = True  # This is only a temporary workaround
        # Both above flags will be removed once
        # four-state will be a full non-experimental feature
